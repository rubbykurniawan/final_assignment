...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post insurances_url, params: { insurance: { address: @insurance.address, code: @insurance.code, name: @insurance.name } }
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { address: @insurance.address, code: @insurance.code, name: @insurance.name } }
